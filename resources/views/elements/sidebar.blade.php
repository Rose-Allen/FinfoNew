...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="d-flex flex-stack px-4 px-lg-6 py-3 py-lg-8" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('dashboard.index') }}">
            <img alt="Logo" src="{{ asset('assets/media/logos/demo23.svg') }}"
                 class="h-20px h-lg-25px theme-light-show">
            <img alt="Logo" src="{{ asset('assets/media/logos/demo23-dark.svg') }}"
        ...
        <div id="kt_app_sidebar_nav_wrapper" class="d-flex flex-column hover-scroll-y pe-4 me-n4" data-kt-scroll="true"
            ...
            <div class="mb-6">
                ...
                <div class="row row-cols-2 row-cols-lg-3" data-kt-buttons="true"
                    ...
                    <div class="col mb-4">
                        ...
                        <a href="{{ route('dashboard.index') }}"
                           ...
                           data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                                <img src={{asset("assets/media/icons/duotune/general/gen001.svg")}}/>
                            </span>
                            <!--end::Icon-->
                            <!--begin::Label-->
                    ...
                    <div class="col mb-4">
                        ...
                        <a href="{{ route('client.index') }}"
                           ...
                           data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                             <img src="{{asset('assets/media/icons/duotune/communication/com013.svg')}}"/>
                            </span>
                            <!--end::Icon-->
                            <!--begin::Label-->
                    ...
                    <div class="col mb-4">
                        ...
                        <a href="{{route('products.index')}}"
                           ...
                           data-kt-button="true">
                            ...
                            <!--end::Icon-->
                            <!--begin::Label-->
                            <span class="fs-7 fw-bold">Product</span>
                            <!--end::Label-->
                        </a>
                        <!--end::Link-->
                    </div>
                    ...
                    <div class="col mb-4">
                        <!--begin::Link-->
                        <a href="{{route('user.requisites.index')}}"
                           class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-90px h-90px border-gray-200"
                           data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                               <img src="{{asset('assets/media/icons/duotune/files/fil012.svg')}}"/>
                            </span>
                            <!--end::Icon-->
                            <!--begin::Label-->
                            <span class="fs-7 fw-bold">Requisites</span>
                            <!--end::Label-->
                        </a>
                        <!--end::Link-->
                    </div>
                    ...
                    <div class="col mb-4">
                        ...
                        <a href="#"
                           ...
                           data-kt-button="true">
                            <!--begin::Icon-->
                            <span class="mb-2">
                               <img src="{{asset('assets/media/icons/duotune/finance/fin003.svg')}}"/>
                            </span>
                            <!--end::Icon-->
                            <!--begin::Label-->
                            <span class="fs-7 fw-bold">Payment invoices</span>
                            <!--end::Label-->
                        </a>
                        <!--end::Link-->
                    </div>
