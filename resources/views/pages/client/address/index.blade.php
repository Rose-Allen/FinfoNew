...
@section('content')
    ...
    {{--    @include('pages.client.address.modal.modal-create')--}}
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-0">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('client.index')}}" class="text-muted text-hover-primary">Клиенты</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{route('client.addresses.create', $client->id)}}" class="btn btn-sm fw-bold btn-primary">Create</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Action-->
            </div>
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @foreach($addresses as $address)
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{url('client/addresses/'.$address->id.'/client/'.$client->id.'/edit')}}"
                                ...
                                @include('pages.client.address.modal.modal-delete')
                                <!--end::Table row-->
                            @endforeach
                            </tbody>
                            <!--end::Table body-->
