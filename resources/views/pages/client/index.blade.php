...
@section('content')
    ...
    @include('pages.client.modal.modal-create')
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @foreach($clients as $client)
                                ...
                                <tr>
                                    ...
                                    <!--begin::Last login=-->
                                    <td>
                                        <div class="badge badge-light fw-bold">{{ $client->phone }}</div>
                                    </td>
                                    <!--end::Last login=-->
                                    <!--begin::Joined-->
                                        ...
                                        <div
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="" data-bs-toggle="modal"
                                                   data-bs-target="#modalEdit{{$client->id}}"
                                ...
                                @include('pages.client.modal.modal-edit')
                                @include('pages.client.modal.modal-delete')
                                <!--end::Table row-->
                            @endforeach
                            </tbody>
                            <!--end::Table body-->
